...
## Random data
You can execute script from Requirement 2 to generate the random data. To achieve that install the script on the box that has access to mySQL instance and amend the config.yml file with the host of your database instance.
